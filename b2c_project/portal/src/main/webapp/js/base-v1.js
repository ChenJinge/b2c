 ...
 */
function login() {
    return location.href = "http://sso.b2c.com/page/login";
}
function regist() {
    return location.href = "http://sso.b2c.com/page/register";
}
...
function search(a) {
    var b = "http://www.b2c.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
