...
public class CustomBargains extends BargainsEntity {
    ...
    private int startBargainsPrice;
    private int endBargainsPrice;
    ...
    public int getStartBargainsPrice() {
        return startBargainsPrice;
    }

    public void setStartBargainsPrice(int startBargainsPrice) {
        this.startBargainsPrice = startBargainsPrice;
    }

    public int getEndBargainsPrice() {
        return endBargainsPrice;
    }

    public void setEndBargainsPrice(int endBargainsPrice) {
        this.endBargainsPrice = endBargainsPrice;
    }
