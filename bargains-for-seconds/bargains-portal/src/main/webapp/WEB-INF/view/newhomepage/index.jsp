...
<head>
    ...
    <title>友凡秒杀-正品秒杀！</title>


    <link rel="stylesheet" type="text/css" href="/YF_MS_WEB/css/webbase.css"/>
    <link rel="stylesheet" type="text/css" href="/YF_MS_WEB/css/widget-jquery.autocomplete.css"/>
    <link rel="stylesheet" type="text/css" href="/YF_MS_WEB/css/pages-seckill-index.css"/>
...
<div class="py-container index">
    <!--banner-->
    <div class="banner">
        <img src="/YF_MS_WEB/img/_/banner.png" class="img-responsive" alt="">
    </div>
    ...
    <div class="cd-top">
        <div class="top">
            <img src="/YF_MS_WEB/img/_/gotop.png"/>
            <b>TOP</b>
        </div>
        <div class="code" id="code">
            <span><img src="/YF_MS_WEB/img/_/code.png"/></span>
        </div>
        <div class="erweima">
            <img src="/YF_MS_WEB/img/_/erweima.jpg" alt="">
            <s></s>
        </div>
    </div>
</div>
